...
| [RV-1](#rv-1--workplace-fairness-act-attributes) | Workplace Fairness Act attributes not yet ignored | **Deferred** (deadline) | Before the Act takes effect (end-2027) | none; written deferral, reviewed in [#176](https://github.com/dczii/URecruitment/issues/176) | none |
...
| Status | **Deferred**, with a deadline |
| Owner slot | — *(unassigned)* |
